...
namespace src.Migrations
{
    ...
    [Migration("20240313022944_CatheringService")]
    partial class CatheringService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("src.Models.CateringService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_catering_service");

                    b.ToTable("catering_service", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "info@cateringsoluciones.com",
                            IsActive = true,
                            Name = "Catering Soluciones",
                            Phone = "2271 7575"
                        },
                        new
                        {
                            Id = 2,
                            Email = "info@lacucharaderebe.com",
                            IsActive = true,
                            Name = "Servicio & Sazón - Catering Service",
                            Phone = "7150 9328"
                        },
                        new
                        {
                            Id = 3,
                            Email = "pastaprontocr@gmail.com",
                            IsActive = true,
                            Name = "Pasta Pronto Express y Catering",
                            Phone = "4704 8057"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("src.Models.Event", b =>
                {
                    ...
                    b.Property<int>("IdCateringService")
                        .HasColumnType("int")
                        .HasColumnName("id_catering_service");
                    ...
                    b.HasIndex("IdCateringService")
                        .HasDatabaseName("ix_event_id_catering_service");
            ...
            modelBuilder.Entity("src.Models.Event", b =>
                {
                    b.HasOne("src.Models.CateringService", "CateringService")
                        .WithMany()
                        .HasForeignKey("IdCateringService")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_catering_service_id_catering_service");
